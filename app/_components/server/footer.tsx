import logoNoBac from "@/public/logoNoBac.png";
import Image from "next/image";
import Link from "next/link";
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-b from-anotherLight to-[#AE9460] pt-12">
      <div className="mx-auto w-full p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              <h2 className="mb-6 text-sm font-bold text-maindark uppercase">Legal</h2>
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <Link href={"/make-ticket"} className="text-mainlight hover:underline">
                    Report
                  </Link>
                </li>
                <li className="mb-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-mainlight sm:text-center">
            © 2024 . All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center gap-3 sm:mt-0">
            <a href="#" className="text-anotherLight hover:text-mainlight duration-200">
              <svg
                className="w-4 h-4"
                aria-hidden="true"
